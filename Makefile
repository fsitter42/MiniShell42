...
#    Updated: 2026/03/11 16:26:58 by slambert         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = minishell

SRC =	main/minishell.c commandizer/commandizer.c cleanup/cleanup.c \
		tokenizer/tokenizer.c expansion/expansion.c word_splitting/word_splitting.c \
